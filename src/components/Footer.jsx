...
const Footer = () => {
  return (
    <footer className="relative bg-[#683292]">
      <div className="max-w-[1440px] mx-auto px-16 pt-25">
        <div className="max-w-[calc(1440px-260px)] mx-auto flex justify-between items-start [&_p]:font-[Archivo] [&_p]:text-[#CFB6E2] [&_h5]:font-[Archivo] [&_h5]:font-semibold [&_h5]:text-white  [&_p]:text-sm">
          <a href="./">
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="font-[Archivo] text-[#CFB6E2] text-sm list-disc marker:text-[#F83D8E] grid grid-cols-2 gap-x-12 gap-y-4 marker:mr-3">
              <li>
